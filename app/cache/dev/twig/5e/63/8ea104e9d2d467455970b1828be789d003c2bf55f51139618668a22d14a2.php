...
/* CoutureFacturationBundle:Etatfacture:index.html.twig */
class __TwigTemplate_5e638ea104e9d2d467455970b1828be789d003c2bf55f51139618668a22d14a2 extends Twig_Template
{
    ...
    public function block_title($context, array $blocks = array())
    {
        ...
        echo " - ";
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("views.index.list", array("%entity%" => "Etatfacture"), "JordiLlonchCrudGeneratorBundle"), "html", null, true);
        echo "
";
    }
...
<div class=\"row\">
    ...
    <div class=\"span12\">
        ...
        echo "
                ";
        // line 36
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["filterForm"]) ? $context["filterForm"] : $this->getContext($context, "filterForm")), "libelle", array()), 'row');
        echo "
                ";
        // line 37
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["filterForm"]) ? $context["filterForm"] : $this->getContext($context, "filterForm")), "description", array()), 'row');
        echo "
                ";
        // line 38
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            <td><a href=\"";
            // line 62
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("etatFacture_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
        ...
        <a class=\"btn btn-mini\" href=\"";
            // line 69
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("etatFacture_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">
            ";
            // line 70
    ...
    <a class=\"btn btn-primary likepaginator\" href=\"";
        // line 83
        echo $this->env->getExtension('routing')->getPath("etatFacture_new");
        echo "\">
            ";
        // line 84
...
";
    ...
    {
        return "CoutureFacturationBundle:Etatfacture:index.html.twig";
    }
    ...
    {
        return array (  208 => 84,  204 => 83,  197 => 79,  190 => 74,  180 => 70,  176 => 69,  171 => 67,  167 => 66,  162 => 64,  158 => 63,  152 => 62,  149 => 61,  145 => 60,  138 => 56,  121 => 42,  117 => 41,  111 => 38,  107 => 37,  103 => 36,  99 => 35,  93 => 34,  81 => 25,  74 => 20,  68 => 17,  65 => 16,  63 => 15,  57 => 12,  51 => 8,  48 => 7,  40 => 4,  37 => 3,  11 => 1,);
    }
}
